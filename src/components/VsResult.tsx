...
export default function VsResult({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4">
      ...
      <motion.div
        className="bg-white/80 backdrop-blur rounded-2xl p-6 shadow-lg mb-6 text-lg space-y-3 w-full max-w-sm"
      ...
      >
        ...
        <motion.button
          onClick={onGoHome}
          className="bg-white/80 px-8 py-4 rounded-2xl font-bold text-xl shadow-lg"
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
        >
          🏠 처음으로
